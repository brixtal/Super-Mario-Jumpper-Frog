	...
	while(!quit) 
   	{
		...
		else
		{
			...
			checa_sprite_right(tronco1, 600);
			checa_sprite_left(tronco2, 600);
			checa_sprite_left(tronco3, 600);
			checa_sprite_right(tronco4, 600);
			checa_sprite_right(carro1, 600);
			checa_sprite_left(carro2, 600);
			checa_sprite_right(carro3, 600);
			checa_sprite_left(carro4, 600);
			...
			if(checa_casa1 == TRUE && checa_casa2 == TRUE)
			{
				nivel = 2;
				quit = 1;
				score_player = frog.score * ((300 - timer.ticks/1000)/10);
			}
		}
